...
.auth-card {
  ...
  width: 100%;
  max-width: 480px; /* Un poco más ancho para las filas dobles */
}
.auth-footer { margin-top: 24px; text-align: center; }
.signup-prompt { font-size: 14px; color: #546e7a; display: flex; justify-content: center; align-items: center; gap: 6px; }
.link-accent { color: #11a691; text-decoration: none; font-weight: 700; }
</style>