...
const closeLogoutConfirm = () => { if (!isLoggingOut.value) showLogoutConfirm.value = false }
    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        <div class="nav-group">
          ...
          <RouterLink to="/empleado" class="nav-item" active-class="active" exact>
...
.brand-title { margin: 0; font-size: 1rem; font-weight: 700; }
.brand-subtitle { margin: 4px 0 0; font-size: 0.72rem; color: #8fa8a2; }
...
.nav-item:hover { background-color: rgba(17, 153, 142, 0.15); color: white; }
.nav-item.active { background-color: #11998e; color: white; font-weight: 600; }
...
.user-name { margin: 0 0 2px; font-size: 0.85rem; color: white; font-weight: 600; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.user-email { margin: 0; font-size: 0.75rem; color: #8fa8a2; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
...
.btn-logout:hover { background-color: #e53935; color: white; border-color: #e53935; }
...
.modal-title { margin: 0 0 10px; color: #0d9b8a; font-size: 1.3rem; font-weight: 700; }
.modal-text { margin: 0 0 22px; color: #6b7280; font-size: 0.98rem; }
.modal-actions { display: flex; gap: 12px; justify-content: center; }
.modal-cancel-btn, .modal-confirm-btn {
  border: none; border-radius: 999px;
  padding: 12px 18px; font-size: 0.95rem; font-weight: 600; cursor: pointer;
}
.modal-cancel-btn { background: #f3f4f6; color: #374151; }
.modal-confirm-btn { background: #18b4a3; color: white; }
.modal-cancel-btn:disabled, .modal-confirm-btn:disabled { opacity: 0.7; cursor: not-allowed; }
